...
SECRET_KEY = 'django-insecure-h+x_)7txz$(v+35eoqun*xr9%a-n4+3h(8$lwi5-^42-fyfeuz'
...
if os.environ.get('GITHUB_WORKFLOW') or os.environ.get('CI') or os.environ.get('MYSQL_DB'):
    DATABASES = {
        'default': {
